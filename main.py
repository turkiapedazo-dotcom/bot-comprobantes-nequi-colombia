...
async def nequicol_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        logger.error(f"Error en vttacrew_command: {str(e)}")
        ...
        for member in update.message.new_chat_members:
            if member.id == context.bot.id:
                ...
                await update.message.reply_text(
                    ...
                    f"📢 Grupo oficial: https://t.me/Vttacrew"
                )
    except Exception as e:
    ...
    try:
        ...
        if user_id in user_data_store:
            ...
            await update.message.reply_text(
                ...
                "Presiona /Vttacrew para generar un nuevo comprobante.",
                reply_markup=ReplyKeyboardRemove()
            )
        else:
            await update.message.reply_text(
                "❌ No hay ninguna operación activa para cancelar.\n\n"
                "Presiona /Vttacrew para generar un comprobante.",
                reply_markup=ReplyKeyboardRemove()
            )
    except Exception as e:
